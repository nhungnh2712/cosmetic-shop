...
if (db.get('categories').size().value() === 0) {
  ...
  const products = [
    ...
    { id: 4, name: 'Son môi MAC Ruby Woo', description: 'Son lì màu đỏ cổ điển, lâu trôi, không khô môi.', price: 650000, sale_price: 580000, stock: 25, image: 'https://images.unsplash.com/photo-1487412947147-5cebf100ffc2?w=400&q=80', category_id: 2, brand: 'MAC', created_at: now },
    { id: 5, name: 'Phấn nền Maybelline Fit Me', description: 'Phấn nền che phủ tốt, kiểm soát dầu, 40 tông màu.', price: 195000, sale_price: 165000, stock: 60, image: 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=400&q=80', category_id: 2, brand: 'Maybelline', created_at: now },
    ...
    { id: 9, name: 'Nước hoa Chanel No.5', description: 'Hương thơm hoa cỏ cổ điển, sang trọng và quyến rũ.', price: 2800000, sale_price: 2500000, stock: 10, image: 'https://images.unsplash.com/photo-1594035910387-fea47794261f?w=400&q=80', category_id: 4, brand: 'Chanel', created_at: now },
